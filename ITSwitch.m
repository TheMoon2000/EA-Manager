...
static CGFloat const kGoldenRatio = 1.55803398875f;
static CGFloat const kDecreasedGoldenRatio = 1.45;
...
#define kDisabledBorderColor [NSColor colorWithCalibratedWhite:0.f alpha:0.18f]
